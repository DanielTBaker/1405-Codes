...
def template_match(template, z, off_gates = None, smart_guess = True, xguess=[0.,1.], method='Nelder-Mead'):
    """
    ...
    xguess :
        Only used if smart_guess is set to False. Initial guess [dt, scaling] for the minimization.
